...
export const data: CandlestickData[] = [
 ...
 export const sentimentRating: LineData[] = [
    { time: { year: 2018, month: 9, day: 22 }, value: 1 },
    { time: { year: 2018, month: 9, day: 25 }, value: 8 },
    { time: { year: 2018, month: 9, day: 28 }, value: 5 },
    { time: { year: 2018, month: 10, day: 1 }, value: 4 },
    { time: { year: 2018, month: 10, day: 4 }, value: 3 },
    { time: { year: 2018, month: 10, day: 7 }, value: 6 },
    { time: { year: 2018, month: 10, day: 10 }, value: 7 },
    { time: { year: 2018, month: 10, day: 13 }, value: 2 },
    { time: { year: 2018, month: 10, day: 16 }, value: 9 },
    { time: { year: 2018, month: 10, day: 19 }, value: 8 },
    { time: { year: 2018, month: 10, day: 22 }, value: 7 },
    { time: { year: 2018, month: 10, day: 25 }, value: 6 },
    { time: { year: 2018, month: 10, day: 28 }, value: 5 },
    { time: { year: 2018, month: 10, day: 31 }, value: 4 },
    { time: { year: 2018, month: 11, day: 3 }, value: 3 },
    { time: { year: 2018, month: 11, day: 6 }, value: 2 },
    { time: { year: 2018, month: 11, day: 9 }, value: 1 },
    { time: { year: 2018, month: 11, day: 12 }, value: 2 },
    { time: { year: 2018, month: 11, day: 15 }, value: 3 },
    { time: { year: 2018, month: 11, day: 18 }, value: 4 },
    { time: { year: 2018, month: 11, day: 21 }, value: 5 },
    { time: { year: 2018, month: 11, day: 24 }, value: 6 },
    { time: { year: 2018, month: 11, day: 27 }, value: 7 },
    { time: { year: 2018, month: 11, day: 30 }, value: 8 },
    { time: { year: 2018, month: 12, day: 3 }, value: 9 },
    { time: { year: 2018, month: 12, day: 6 }, value: 8 },
    { time: { year: 2018, month: 12, day: 9 }, value: 7 },
    { time: { year: 2018, month: 12, day: 12 }, value: 6 },
    { time: { year: 2018, month: 12, day: 15 }, value: 5 },
    { time: { year: 2018, month: 12, day: 18 }, value: 4 },
    { time: { year: 2018, month: 12, day: 21 }, value: 3 },
    { time: { year: 2018, month: 12, day: 24 }, value: 2 },
    { time: { year: 2018, month: 12, day: 27 }, value: 1 },
  ];
  
 export const lineMarkers: SeriesMarker<BusinessDay>[] = [
    {
